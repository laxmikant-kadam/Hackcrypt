    ...
    const equipmentItems = [
        {
            ...
            apiEndpoint: "http://127.0.0.1:5000/pathnavigator/start"
        },
        {
            ...
            apiEndpoint: "http://127.0.0.1:5000/activate-vm"
        },
        {
            name: "PDF Reader",
            ...
            action: () => setShowPdfReader(true)  // Changed to use action instead of component
        }
    ];
          ...
          `}>
            ...
            {showPdfReader && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm">
                    <div className="relative w-full h-full max-w-6xl max-h-[90vh] bg-gray-900 rounded-xl overflow-hidden border border-emerald-500/20">
                        <button
                            onClick={() => setShowPdfReader(false)}
                            className="absolute top-4 right-4 z-50 p-2 bg-emerald-900/50 rounded-full hover:bg-emerald-800 transition-colors"
                        >
